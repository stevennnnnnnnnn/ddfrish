...
class OrderInfo(BaseModel):
    ...
    pay_method = models.SmallIntegerField(choices=PAY_METHOD_CHOICES, default=3, verbose_name='zhifufangshi')
    total_count = models.IntegerField(default=1, verbose_name='商品数量')
    total_price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='总价')
    transit_price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='运费')
    order_status = models.SmallIntegerField(choices=ORDER_STATUS_CHOICES, default=1, verbose_name='dingdanzhuangtai')
...
class OrderGoods(BaseModel):
    """订单内商品模型类"""
    order = models.ForeignKey('OrderInfo', verbose_name='订单商品', on_delete=models.CASCADE)
